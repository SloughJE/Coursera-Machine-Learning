...
set.seed(1777)
random_forest=randomForest(classe~.,data=training,ntree=100,importance=TRUE)
random_forest
...
```{r, echo=TRUE,fig.width=10, fig.height=8,fig.align='center'}
...
```{r,echo=FALSE}
CV = trainControl(method = "cv", number = 5, allowParallel = TRUE, verboseIter = FALSE)
